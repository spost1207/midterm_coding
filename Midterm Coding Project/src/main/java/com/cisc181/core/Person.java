...
public abstract class Person implements java.io.Serializable {
	...
	public void setDOB(Date DOB) throws PersonException{
		...
		int yearOfBirth = birthyear.get(Calendar.YEAR);
		if (currentyear.get(Calendar.YEAR) - yearOfBirth >= 100){
	...
	public void setPhone(String newnumber) throws PersonException {
		String Regex = "^\\(?([0-9]{3})\\)?[-.\\s]?([0-9]{3})[-.\\s]?([0-9]{4})$";
		boolean number = Pattern.matches(Regex, newnumber);
